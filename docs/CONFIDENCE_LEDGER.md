...
|---|---|---:|---|---:|
| 1 | Report pages use a static shell + JS hydration model. | 8 | Verified in `reports/youtube-2005.html` (`article[data-report-root]`, script include) and `assets/report.js` hydration functions. | 9 |
...
| 6 | Existing report JSON files provide sufficient structured sections for staged component animation. | 8 | Inspected `assets/reports/youtube-2005.json` structure (`hero`, `evidence_summary`, `stages.stage_1..4`). | 9 |
...
## Evidence index
- `reports/youtube-2005.html`
- `assets/report.js`
- `assets/css/styles.css`
- `assets/app.js`
- `assets/js/main.js`
- `assets/reports/youtube-2005.json`
